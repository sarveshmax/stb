...
export default function PhantomPartnership({ title }: PhantomPartnershipProps) {
  return (
    <div
      className="w-115 flex items-center gap-4
        rounded-2xl mt-2 mb-2 p-4 bg-gradient-to-r from-purple-600/20 to-green-500/20
        border border-white/20 backdrop-blur-md
      "
    >
      {/* PHANTOM LOGO */}
      <img src="/walleticons/phantom.png" alt="Phantom Logo" className="w-7 h-7" />
